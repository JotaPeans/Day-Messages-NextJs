...
const Modal = ({ open, onClose, children }: ModalProps) => {
    return (
        ...
        >
            <div
                data-open={open} 
                className="relative transition-all w-80 h-80 rounded-xl bg-zinc-50 shadow-lg data-[open=true]:animate-appearance-in data-[open=false]:animate-appearance-out flex flex-col p-2 z-50"
            >
